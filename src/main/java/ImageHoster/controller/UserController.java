...
public class UserController {
    ...
    //Checking password strength for alphabets, digits and special characters
    public Boolean checkpassword(String password){
        ...
        return (hasAlpha && hasDigit && specialChar);
    }
    ...
    public String registerUser(User user, Model model) {
        ...
        //Returning boolean value for the password check
