...
public class ImageController {
    ...
    public String showImage(@PathVariable(name = "imageId") Integer imageId, @PathVariable(name = "title") String title, Model model) throws NullPointerException {
        ...
        //Exception handling to check for the empty comments
        try {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        User creator = image.getUser();
        User logged_user = (User) session.getAttribute("loggeduser");
        model.addAttribute("image", image);

        //Getting usernames for verification of the image-creator against the logged-in user
        String logged_username = logged_user.getUsername();
        String creator_username = creator.getUsername();
        //System.out.println(logged_username);
        //System.out.println(creator_username);

        if(!logged_username.equals(creator_username)) {
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId, @RequestParam("tags") String tags, Image updatedImage, HttpSession session) throws IOException {
        ...
        //Adding the parameter to match the URL pattern
